...
public class LikeMessageEvent extends ApplicationEvent {
    private Long targetUid;
    private Long publisherUid;
    private ReplyV2 replyV2;

    public LikeMessageEvent(Object source) {
        super(source);
    }

    public LikeMessageEvent(Object source, Long targetUid, Long publisherUid, ReplyV2 replyV2) {
        super(source);
